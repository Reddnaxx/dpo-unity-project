...
public class EnemySpawner : MonoBehaviour
{
  ...
  [SerializeField] private LayerMask _wallLayer; // Слой стен

  [Header("Wave Settings")]
  [SerializeField] private int _enemiesPerWave = 5;
  [SerializeField] private float _waveCooldown = 10f;
  [SerializeField] private float _spawnCheckRadius = 0.5f; // Радиус проверки стен
  ...
  private void Start()
  {
    ...
    _wallLayer = LayerMask.GetMask("Ground"); // Или ваш слой стен
  }
  ...
  {
    int attempts = 10; // Максимальное количество попыток
    ...
    for (int i = 0; i < attempts; i++)
    {
      ...
      // Проверяем, нет ли стены в точке спавна
    ...
    return Vector2.zero; // Если не нашли валидную позицию
  }

  // Опционально: для визуализации радиуса проверки в редакторе
